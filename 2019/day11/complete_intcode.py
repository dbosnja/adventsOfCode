...
def main(instruction_set, pointer_instruction, relative_base, input_value):
    while True:
        ...
        if op_code == 1:
            ...
            if params[-1] == "0":
                return instruction_set[op_map["first"]], instruction_set, pointer_instruction, relative_base
            elif params[-1] == "1":
                return op_map["first"], instruction_set, pointer_instruction, relative_base
            else:
                return instruction_set[op_map["first"] + relative_base], instruction_set, pointer_instruction, relative_base
        elif op_code == 5:
